    ...
    <Screen style={styles.root}>
      <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : undefined} style={styles.flex}>
        <View style={styles.brand}>
          ...
          <Text variant="display" color={colors.inkOnInverse} style={styles.brandName}>
            {`SmartRiego\nMX`}
          </Text>
        ...
        <View style={styles.form}>
          <View style={styles.formHeader}>
            ...
            <Text color={colors.inkMuted}>Entra para ver el estado de tus parcelas.</Text>
          </View>
          ...
          <View style={styles.fields}>
            ...
            <View style={styles.forgotRow}>
              <Button variant="ghost" title="¿Olvidaste tu contraseña?" onPress={() => undefined} style={styles.forgot} />
            </View>
          </View>
...
const styles = StyleSheet.create({
  ...
  brandBlocks: { flexDirection: 'row', alignItems: 'flex-end', gap: spacing.sm, marginBottom: spacing.xxl },
  blockPrimary: { width: spacing.xxxl, height: blockSize * 3, borderRadius: spacing.sm, backgroundColor: colors.primary },
  blockAccent: { width: blockSize * 3, height: blockSize * 2, borderRadius: spacing.sm, backgroundColor: colors.accent, opacity: 0.85 },
  blockDark: { width: blockSize * 6, height: blockSize, borderRadius: 5, backgroundColor: colors.suedeGreen },
  brandName: { letterSpacing: -0.01 },
  brandTagline: { marginTop: spacing.md, opacity: 0.75, maxWidth: 260, fontSize: 15, lineHeight: 22 },
  form: { flex: 1, justifyContent: 'center', paddingHorizontal: spacing.xl, gap: spacing.xl },
  ...
  footer: { textAlign: 'center', paddingTop: spacing.lg, borderTopWidth: 1, borderTopColor: colors.border },
});