...
export function TextField({ label, error, containerStyle, style, ...inputProps }: TextFieldProps): React.JSX.Element {
  return (
    <View style={[styles.container, containerStyle]}>
      ...
      />
      {error != null ? (
        <Text variant="caption" color={colors.statusDanger} style={styles.error}>
          {error}
        </Text>
      ) : null}
    </View>
